...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    common_vendor.onMounted(() => {
      ...
      AccConfig_answer.search_data.S_height = but_data.height;
      AccConfig_answer.search_data.S_top = but_data.top;
      AccConfig_answer.search_data.S_left = but_data.left - 30;
      AccConfig_answer.search_data.Custom_height = but_data.height + but_data.top + 5;
      goods();
    });
    const result = common_vendor.reactive({ banner: [], seckill: [], card: [] });
